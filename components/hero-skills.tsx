  ...
  return (
    <section id={id} className="relative px-6 pb-24 pt-10 md:px-8">
      <div className="mx-auto grid max-w-6xl gap-14 lg:grid-cols-[1fr_1fr] lg:items-center">
        ...
        <div className="relative mx-auto flex w-full max-w-md justify-center lg:mx-0 lg:justify-end">
          <div className="relative h-[340px] w-[280px] md:h-[400px] md:w-[320px]">
            ...
            <div className="ios-no-backdrop absolute -left-4 bottom-24 flex min-h-[72px] min-w-[72px] max-w-[88px] items-center justify-center rounded-full border border-white/20 bg-sky-600/60 px-2 text-center text-xs font-bold leading-tight text-white backdrop-blur-sm shadow-[0_0_40px_rgba(56,189,248,0.35)] animate-float-soft-delayed sm:text-sm">
            ...
            >
              <Image
                ...
                priority
              />
              <div className="ios-no-blend pointer-events-none absolute inset-0 bg-gradient-to-tr from-indigo-600/35 via-transparent to-cyan-400/20 mix-blend-soft-light" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto mt-20 grid max-w-6xl gap-8 md:grid-cols-2">
        <article className="ios-no-backdrop rounded-[28px] border border-white/[0.08] bg-white/[0.07] p-8 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.06)] backdrop-blur-xl">
